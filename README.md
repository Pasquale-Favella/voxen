...
This creates a portable `dist\Voxen\` folder. If Inno Setup is installed, it also creates `dist\installer\Voxen-Setup-0.1.0.exe`; otherwise the script creates `dist\Voxen-windows.zip`.
