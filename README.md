...
This creates a portable `dist\Voxen\` folder. If Inno Setup is installed, it also creates `dist\installer\Voxen-Setup-0.1.8.exe`; otherwise the script creates `dist\Voxen-windows.zip`.
